...
describe Parser do
    ...
    describe '#get_comment' do
        ...
        context 'when many comments are present' do
            ...
            let(:element) { [ ["OBX", "4", "B250", "++"], ["NTE", "4", "Comment 1 for + result"], ["NTE", "4", "Comment 2 for ++ result"] ] }
    ...
    describe '#map_single_result' do
        ...
        context 'without stubbed method calls' do
            ...
            let(:expected_result) { { :code => "A100", :result => -2.0, :format => "boolean", :comment => "Comment 1 for + result\n" } }
